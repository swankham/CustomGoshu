...
{
    public partial class TeamManagement : EpiBaseForm
    {
        ...
        private void tlSave_Click(object sender, EventArgs e)
        {
            ...
            trans.Tree = _repo.SaveTree(epiSession, trans.Tree);
        }
        ...
        {
            using (TreeList frm = new TreeList(epiSession))
            {
                frm.ShowDialog();
        ...
        private void tlDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                _repo.DeleteRootNode(epiSession, trans.Tree.TreeViewId);
                tlClear_Click(sender, e);
            } 
        }
        ...
        private void AddAuthorized()
        {
            foreach (DataGridViewRow row in dgvAvailable.SelectedRows)
            {
                ...
                _repo.AddAuthorized(epiSession, model);
            }
        ...
        private void butRemove_Click_1(object sender, EventArgs e)
        {
            AddAuthorized();
        }
